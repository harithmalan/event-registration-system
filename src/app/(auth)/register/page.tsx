      ...
      <div className="w-full max-w-md">
        <div className="relative bg-white rounded-2xl p-8 shadow-2xl border border-[#EEE2C8] overflow-hidden">
          ...
          <button
            ...
            className="w-full flex items-center justify-center gap-3 px-4 py-2.5 rounded-xl border-[1.5px] border-[#EEE2C8] bg-white text-[#2B1A0E] text-sm font-medium hover:bg-[#FAF3E0] hover:border-[#C9943A] transition-all disabled:opacity-60 mb-4"
          >
          ...
          <p className="text-center mt-5 text-sm text-[#9C7D5A]">
            ...
            <Link href="/login" className="text-[#7A1F28] font-semibold hover:underline">Sign In</Link>
          </p>
        </div>
      </div>
    </div>
